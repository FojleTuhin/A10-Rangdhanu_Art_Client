...
const Mission = () => {
    return (
        <div className="max-w-6xl mx-auto mt-20 px-5 gap-5 md:flex  ">
            ...
            <div className="md:w-[60%] px-3 md:px-5 lg:px-0 h-[500px] relative  ">

                <div className="flex justify-end">
                    <img className="rounded-3xl h-[400px]" src="https://i.ibb.co.com/sW4pjRz/pexels-olly-933255.jpg" alt="" />
                </div>

                <div className="py-[47px] absolute bottom-1 pl-[30px] pr-5 rounded-[32px] bg-[#343268] md:w-[380px] h-[210px]">
