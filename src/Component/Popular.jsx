    ...
    return (
        <div className="px-4 md:px-8 lg:px-[100px] pt-10 pb-1 font-semibold">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 md:gap-8 gap-4">
                <div data-aos="fade-right" className="bg-[#D9D9D9] rounded-xl ">
                ...
                <div data-aos="fade-left" className="bg-[#D9D9D9] rounded-xl">
                ...
                <div data-aos="fade-left" className="bg-[#D9D9D9] rounded-xl justify-center">
